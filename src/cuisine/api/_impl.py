...
class API(Interface):
     ...
     def connect(self, host=None, port=None, user=None, password=None, key_path: Optional[pathlib.Path] = None) -> cuisine.connection.Connection:
        ...
        not supported."""
          return self._connection.connect(host, port, user, password, key_path)

     def connect_local(self) -> cuisine.connection.Connection:
          """None"""
          return self._connection.connect_local()

     def connect_paramiko(self, host=None, port=None, user=None, password=None, key_path: Optional[pathlib.Path] = None) -> cuisine.connection.Connection:
          """None"""
          return self._connection.connect_paramiko(host, port, user, password, key_path)
     ...
     def file_upload(self, local, remote, sudo=None, scp=False):
        ...
        exists or the content are different."""
          return self._file.file_upload(local, remote, sudo, scp)
