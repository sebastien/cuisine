...
def connect( host=None, port=None, user=None, password=None, key_path: Optional[pathlib.Path] = None) -> cuisine.connection.Connection:
     """Connects to the given host/port using the given user/password/key_path credentials. Note that
        ...
        not supported."""
     return default_api().connect(host, port, user, password, key_path)

def connect_local(self) -> cuisine.connection.Connection:
     """None"""
     return default_api().connect_local()

def connect_paramiko( host=None, port=None, user=None, password=None, key_path: Optional[pathlib.Path] = None) -> cuisine.connection.Connection:
     """None"""
     return default_api().connect_paramiko(host, port, user, password, key_path)
...
def file_upload( local, remote, sudo=None, scp=False):
     ...
     return default_api().file_upload(local, remote, sudo, scp)
